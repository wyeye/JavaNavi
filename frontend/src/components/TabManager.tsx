...
const TABS_WITHOUT_CONNECTION_ACCENT = new Set<TabData['type']>([
  'table',
  'design',
  'trigger',
  'view-def',
...
const shouldShowConnectionAccent = (tab: TabData): boolean => !TABS_WITHOUT_CONNECTION_ACCENT.has(tab.type);
