...
public final class FileWorkflowContracts {
    ...
    public record ImportRunResponse(
            ...
            List<Map<String, Object>> duplicateLogCodes,
            String duplicateStrategy,
            String duplicateStrategyCode,
            List<String> duplicateColumns,
            String duplicateWarning,
            String duplicateWarningCode,
            String errorSummary,
            boolean dryRun,
        ...
        public static ImportRunResponse from(Map<String, Object> map) {
            ...
            return new ImportRunResponse(
                    ...
                    intValue(source.get("skippedDuplicates")),
                    stringList(source.get("duplicateLogs")),
                    rowList(source.get("duplicateLogCodes")),
                    text(source.get("duplicateStrategy")),
                    text(source.get("duplicateStrategyCode")),
                    stringList(source.get("duplicateColumns")),
                    text(source.get("duplicateWarning")),
                    text(source.get("duplicateWarningCode")),
